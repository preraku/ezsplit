    ...
    <div className="space-y-3">
      ...
      <div className="flex gap-2">
        <button
          type="button"
          onClick={setAll}
          className="px-3 py-1 rounded-full text-xs font-semibold bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300 active:bg-blue-200 dark:active:bg-blue-800"
        >
          All
        </button>
        <button
          type="button"
          onClick={setNone}
          className="px-3 py-1 rounded-full text-xs font-semibold bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-400 active:bg-gray-200 dark:active:bg-gray-700"
        >
          None
        </button>
      </div>
